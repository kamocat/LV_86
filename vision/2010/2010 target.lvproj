...
<Project Type="Project" LVVersion="8608001">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Find targets from image.vi" Type="VI" URL="../Find targets from image.vi"/>
		<Item Name="target info 1.ctl" Type="VI" URL="../target info 1.ctl"/>
		<Item Name="relate circles of target.vi" Type="VI" URL="../relate circles of target.vi"/>
		<Item Name="get real measurements on target (relative).vi" Type="VI" URL="../get real measurements on target (relative).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Find circles.vi" Type="VI" URL="../Find circles.vi"/>
